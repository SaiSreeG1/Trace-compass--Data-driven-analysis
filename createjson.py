...
# Define the XML and prompts mapping
prompts_xml_mapping = {
...
# Transform the existing dataset to include metadata
transformed_prompts_xml_mapping = {
    "User_Inputted": {},
    "LLM_Generated": {}
}

for prompt, xml in prompts_xml_mapping.items():
    transformed_prompts_xml_mapping["User_Inputted"][prompt] = {
        "User_inputted": True,
        "LLM_Snippet": False,
        "XML": xml
    }

# Save the transformed mapping to a JSON file
def save_transformed_dataset(file_path):
    with open(file_path, "w") as f:
        json.dump(transformed_prompts_xml_mapping, f, indent=4)
    print("Transformed JSON dataset created successfully.")

# Call the function to save the transformed dataset
save_transformed_dataset("trans_dataset.json")
